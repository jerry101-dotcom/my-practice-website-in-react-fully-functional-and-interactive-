...
import theRealDeal from "../assets/image-real-deal.webp"
...
function About() {
  ...
  return (
    <main>
      ...
      <section className="world-class-talent the-real-deal">
        <div className="wct-image-wrapper">
            <img src={theRealDeal} alt="world-best-talent" />
        </div>
        <div className="w-c-t-text t-r-d-text">
          <h1>World-class talent</h1>
          <p>
            We are a crew of strategists, problem-solvers, and technologists.
            Every design is thoughtfully crafted from concept to launch,
